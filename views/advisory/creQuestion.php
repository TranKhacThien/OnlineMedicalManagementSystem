<div class='row'>
    ...
    <div border-style: solid class='col-md-8'>  
        <form action="" class="form" method="post">
            <h3 class='text-light' >Đặt câu hỏi
                <?php 
                    if( isset($data[0]) ){
            ...
            <div class="form-group">
                <label for='questionTitle' class="text-light">Chủ đề:</label><br>
                <input type="text" name="questionTitle" class="form-control">
            </div>
            <div class="form-group">
                <label for="questionDetail" class="text-light">Nội dung câu hỏi:</label><br>
